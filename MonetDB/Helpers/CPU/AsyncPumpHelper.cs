...
namespace MonetDB.Helpers.CPU
{
    ...
    public static class AsyncPumpHelper
    {
        ...
        private sealed class SingleThreadSynchronizationContext : SynchronizationContext
        {
            ...
            private readonly BlockingCollection<KeyValuePair<SendOrPostCallback, object>> _mQueue = new BlockingCollection<KeyValuePair<SendOrPostCallback, object>>();
